...
// the storage library's iamauth package; this adapter only maps TIB config onto
// iamauth.Config.
func buildIAMAuthOption(ctx context.Context, cfg configuration.IAMAuthConfig) (model.Option, error) {
	if !cfg.Enabled {
		return nil, nil
	}
