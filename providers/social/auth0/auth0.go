...
var (
	AuthURL    = "https://tyk.auth0.com/authorize"
	TokenURL   = "https://tyk.auth0.com/oauth/token"
	ProfileURL = "https://tyk.auth0.com/userinfo"
	EmailURL   = "https://tyk.auth0.com/user/emails"
)
...
func (p *Provider) FetchUser(session goth.Session) (goth.User, error) {
	...
	fmt.Println("Fetching Auth0 user data")
...
func (p *Provider) RefreshToken(refreshToken string) (*oauth2.Token, error) {
	return nil, errors.New("Refresh token is not provided by auth0")
}
